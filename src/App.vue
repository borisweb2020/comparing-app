    ...
    data(){
      return {
        ...
        smartphones: [
          ...
          {producer: 'Apple iPnone 50', release: '2020', diagonal: '6.1', state: 'Китай', memory: '128 Гб', refresh: '60 Гц', nfc: false, esim: true, charging: true, price: '81 990 Р', url: 'src/assets/images/apple-12.jpg'},
          {producer: 'Xiaomi Mi 500 Lite', release: '2021', diagonal: '6.55', state: 'Китай', memory: '128 Гб', refresh: '90 Гц', nfc: true, esim: true, charging: false, price: '27 490 Р', url: 'src/assets/images/xiaomi-11.jpg'},
          {producer: 'Samsung Galaxy 600', release: '2021', diagonal: '6.7', state: 'Вьетнам', memory: '128 Гб', refresh: '90 Гц', nfc: true, esim: false, charging: true, price: '32 890 Р', url: 'src/assets/images/samsung-72.jpg'},
          {producer: 'Apple iPnone 888', release: '2020', diagonal: '6.1', state: 'Китай', memory: '128 Гб', refresh: '60 Гц', nfc: false, esim: true, charging: true, price: '81 990 Р', url: 'src/assets/images/apple-12.jpg'},
          {producer: 'Xiaomi Mi 444', release: '2021', diagonal: '6.55', state: 'Китай', memory: '128 Гб', refresh: '90 Гц', nfc: true, esim: true, charging: false, price: '27 490 Р', url: 'src/assets/images/xiaomi-11.jpg'},
        ],
        smartphonesDisplay: [],
      }
    },
